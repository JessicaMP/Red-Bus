export default function () {
  return {
    navs: ['Banca por Internet', 'Pagar en efectivo'],
    online: {
      banks: [
    ...
    ofline: {
      banks: [
        ...
        { name: 'interbank', text: 'Agentes y Bodegas Agencias', img: 'assets/images/logo-interbank.svg', pasos: ['Indica que vas a realizar un pago a la empresa PAGOEFECTIVO. Indica el Código CIP: 9125682 y el importe a pagar en Soles.'], disclaimer: ['Agentes Interbank: Brinda el código de empresa 2735001', 'Agencias Market de Interbank: Costo adicional: S/2.00'] },
        { name: 'banbif', text: 'Agencias', img: 'assets/images/logo-banbif.svg', pasos: ['Indica que vas a realizar un pago a la empresa PAGOEFECTIVO. Indica el Código CIP: 9125682 y el importe a pagar en Soles.'], disclaimer: [] },
        { name: 'Full Carga', text: 'Agentes y Bodegas', img: 'assets/images/logo-fullcarga.png', pasos: ['Indica que vas a realizar un pago a la empresa PAGOEFECTIVO. Indica el Código CIP: 9125682 y el importe a pagar en Soles.'], disclaimer: ['Encuentra a Full Carga en Bodegas, Farmacia, cabinas de Internet y Locutorios', ''] },
