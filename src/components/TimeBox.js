...
const TimeBox = date => (
	<div className="row mx-2 printMe timeBox">
		<div className="p-1 rounded-left col-md-3 col-4 d-flex flex-column align-items-center bg-yellow-hsl justify-content-center">
			<p className="text-light mb-0">Código de pago</p>
			<p className="code mb-0 text-center text-light font-weight-bold">9125682</p>
		</div>
		<div className=" price p-0 col-md-5 col-3 d-flex flex-column align-items-center justify-content-center bg-light">
			<p className="align-middle m-0 font-weight-bold">TOTAL</p>
			<div>
				<p className="m-0 font-weight-400">S/. 140.00</p>
			</div>
		</div>
		<div className="p-2 rounded-right col-md-4 col-5 d-flex justify-content-center align-items-center color-time-box border-right">
			...
			<div className="media-body col-md-8 px-1">
				...
				<p className="text-center m-0 time font-weight-400">{moment(time).format('lll')}</p>
			</div>
		</div>
	</div>
)
